  ...
  const RenderAddMoreDetails = () => {
    ...
    return (
      <div className="modal_view">
        ...
        <div id="add_history" >
          <div className="d-flex flex-row justify-content-between" style={{ width: '55%', marginTop: 40 }}>
            <strong style={{ textAlign: "left", marginBottom: 5 }}>Add History</strong>
          ...
          <div className="box_container">
                    ...
                    return (
                      <>
                        <div key={index} className="upload_fileBox mr-3">
                          <img src={pdfImg} alt="harry potter" style={{ height: 60, width: 60 }} />
                          {
                            uploadSucess?.historyAttach &&
                            <div className="delete_file" onClick={() => {
                              let value = getHistoryImages.filter((item) => item?.name !== img?.name)
                        ...
                        </div>
                        {
                          ...
                          <div className="upload_fileBox mr-3" onClick={() => { handleClick('attach') }}>
                            <FileUploadIcon />
                          </div>
                        }
            ...
            <div className="mt-1 justify-content-end d-flex">
              <ButtonCancel variant="outline-primary"
              // onClick={() => 
              >Save</ButtonCancel>
            </div>
          </div>

          <strong style={{ textAlign: "left", marginTop: 40, marginBottom: 5 }}>Upload Report</strong>
          <div className="box_container">
            <div className="flex-row d-flex">
              {
                getUplodImages.length > 0 ?
                  getUplodImages.map((img, index) => {
                    return (
                      <>
                        <div key={index} className="upload_fileBox" style={{ height: 84 }}>
                          <img src={docxImg} alt="harry potter" style={{ height: 60, width: 60 }} />
                          {
                            uploadSucess?.uploadReport &&
                            <div className="delete_file" onClick={() => {
                              let value = getUplodImages.filter((item) => item?.name !== img?.name)
                              console.log("val", value);
                        ...
                        </div>
                        {
                          ...
                          <div className="upload_fileBox mr-3" onClick={() => { handleClick() }}>
                            <FileUploadIcon />
                          </div>
                        }
                  ...
                  :
                  <div className="upload_fileBox ms-0"
            ...
            <div className="mt-1 justify-content-end d-flex">
              <ButtonCancel variant="outline-primary"
                onClick={() => UploadImageToServer({ end_point: 'upload', data: getUplodImages, call_back: handleResponseImge, props: dataModal?.id })}
              >Save</ButtonCancel>
            </div>
          </div>

          <strong style={{ textAlign: "left", marginTop: 40, marginBottom: 5 }}>Urjent</strong>
          <div className="box_container">
            <RadioGroup
              row
          ...
          <strong style={{ textAlign: "left", marginTop: 40, marginBottom: 5 }}>Doctor Remarks</strong>
          <div className="box_container">
            <div className="flex-row d-flex">
          ...
          <div className="button_group mb-3">
            <ButtonCancel variant="outline-dark"
